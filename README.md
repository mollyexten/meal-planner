...
| Format photos appended to DOM | H | 1 hr | 1 hr | 1 hr |
| Flexbox for index page | H | 2 hrs | 2 hrs | 2 hrs |
| Flexbox for search results | H | 3 hrs | 1.5 hrs | 1.5 hrs |
| Flexbox for individual recipes | H | 2 hrs | 1 hr | 1 hr |
| CSS color and font styling | H | 1 hr | 2 hrs | 2 hrs |
| Add icons to buttons | H | 1.5 hrs | 1 hr | 1 hr |
| *ADDED* Stylize the "no results" option | H | 1 hr | .5 hrs | .5 hrs |
| *ADDED* Make click events more noticeable with styling | H | 1.5 hrs | .5 hrs |  |
| Media query for desktop - index | H | 2 hrs | 2 hrs | 2 hrs |
| Media query for desktop - search | H | 2 hrs | 2.5 hrs | 2.5 hrs |
| Media query for desktop - recipe | H | 2 hrs | 2.5 hrs | 2.5 hrs |
| Create a "save recipes" function | H | 3hrs| 3 hrs | 3 hrs |
| Display saved recipes in recipe-box page | H | 2 hrs | 2 hrs | 2 hrs |
| ~~Compile saved recipes' ingredients to grocery list~~ | ~~H~~ | ~~3 hrs~~ |  |  |
| ~~Add amounts to grocery list~~ | ~~H~~ | ~~3 hrs~~ |  |  |
| *ADDED* Stylize the heading - maybe an icon? | H | 1.5 hrs | 1.5 hrs | 1.5 hrs |
| Organize final CSS | H | 1 hr | 2 hrs | 2 hrs |
| *ADDED* Cleaning up code | H | 1.5 hrs | 3 hrs | 3 hrs |
| *ADDED* Display number of search results | H | 1.5 hrs | 1 hr | 1 hr |
| *ADDED* Add option to explore recipes within category | H | 2 hrs | 2 hrs | 2 hrs |
| Total | H | 42.5 hrs| 40.5 hrs | 40.5 hrs |
